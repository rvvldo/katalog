    ...
    packages: [
        {
            ...
            features: ['Landing page / portfolio', 'Domain .my.id', 'Hosting', 'Desain responsif mobile', '2x revisi gratis'],
        },
        {
            id: 'pro',
            name: 'Pro',
            ...
            features: ['Website multi-halaman', 'Domain .com', 'Hosting', 'Desain korporat', '2x revisi gratis'],
        },
    ],
    addons: [
